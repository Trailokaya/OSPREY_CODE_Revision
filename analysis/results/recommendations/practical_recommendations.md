...
| Missingness language | Use weak/inconsistent evidence language rather than claiming MCAR or MAR. | Observed associations with PM2.5 and spatial variability are present but not strong enough for formal missing-at-random claims. | SI missingness discussion | Filtering missing sensors can change the finite-population estimand. |

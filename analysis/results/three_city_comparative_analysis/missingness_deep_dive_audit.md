...
| --- | --- | --- | --- | --- |
| Chicago | calendar_time | 0.038 | 0.365 | 0.014 |
| Chicago | daily_spatial_cv | 0.037 | 0.411 | 0.014 |
| Chicago | daily_mean_pm25 | -0.034 | 0.446 | 0.014 |
| Dhaka | calendar_time | -2.590 | 0.002 | 0.072 |
| Dhaka | daily_spatial_cv | -0.937 | 0.157 | 0.072 |
| Dhaka | daily_mean_pm25 | -0.661 | 0.446 | 0.072 |
| Lucknow | calendar_time | 4.502 | 0.000 | 0.339 |
| Lucknow | daily_mean_pm25 | -2.476 | 0.000 | 0.339 |
| Lucknow | daily_spatial_cv | 0.519 | 0.178 | 0.339 |
...
| --- | --- | --- | --- | --- |
| Chicago | daily_spatial_sd | 12 | 229 | 0.212 |
| Chicago | daily_spatial_cv | -14 | 227 | -0.207 |
| Chicago | daily_mean_pm25 | 12 | 229 | 0.164 |
...
| --- | --- | --- | --- | --- |
| Chicago | DJJWX4142 | 2025-12-02 | 2026-04-30 | 150 |
| Chicago | DMAEX1156 | 2025-12-11 | 2026-04-30 | 141 |
| Chicago | DSSQU9498 | 2025-09-01 | 2025-12-13 | 104 |
| Chicago | DDVZB7943 | 2025-12-17 | 2026-03-06 | 80 |
| Chicago | DEYGE9157 | 2026-02-12 | 2026-04-30 | 78 |
...
| --- | --- | --- | --- | --- | --- |
| Chicago | 22 | 2.485 | 8 | 8.573 | 6.088 |
...
| Chicago | 277 | 84.579 | 88.288 | 11 | 4 | 10 | 3 |

## Spatial Clustering Of Sensor Missingness

| city | metric | morans_i | permutation_p_two_sided | permutation_p_positive_clustering |
| --- | --- | --- | --- | --- |
| Dhaka | record_missing_pct | 0.201 | 0.018 | 0.011 |
| Dhaka | daily_missing_pct | -0.008 | 0.931 | 0.355 |
| Dhaka | longest_missing_gap_days | -0.079 | 0.416 | 0.691 |
| Lucknow | record_missing_pct | 0.008 | 0.906 | 0.345 |
| Lucknow | daily_missing_pct | 0.003 | 0.959 | 0.370 |
| Lucknow | longest_missing_gap_days | -0.060 | 0.351 | 0.765 |
| Chicago | record_missing_pct | 0.065 | 0.046 | 0.046 |
| Chicago | daily_missing_pct | 0.065 | 0.048 | 0.048 |
| Chicago | longest_missing_gap_days | 0.056 | 0.059 | 0.059 |
...
| Chicago | record_uptime_ge_75pct | 266 | 241 | -0.002 | 0.009 | 0.054 | 1.000 |
| Chicago | daily_uptime_ge_75pct_and_gap_le_30d | 265 | 241 | -0.004 | 0.010 | 0.055 | 1.000 |
| Chicago | exclude_gap_gt_90d | 274 | 241 | -0.000 | 0.003 | 0.016 | 1.000 |

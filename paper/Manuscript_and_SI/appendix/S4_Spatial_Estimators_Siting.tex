...
We repeated the \city{Chicago} $N^*=50$ strategy comparison under $10$ independent master seeds, with $10$ outer finite-population draws per seed and $B=10{,}000$ inner SRSWOR draws per task. The strategy ordering is qualitatively preserved across seeds. Across-seed median MdAPE-at-$n=10$ values are cluster-concentrated $1.74\%$, k-means stratified $1.76\%$, random $1.79\%$, circumferential $1.94\%$, anti-cluster $2.24\%$, and spatially balanced $2.29\%$, with cluster-concentrated and anti-cluster strategies remaining near the low- and high-MdAPE ends respectively across seeds. The anti-cluster strategy has the tightest seed band ($5$--$95\%$ width $0.03$~pp), as expected for a fully deterministic selection; random has the widest band ($5$--$95\%$ width $0.55$~pp), as expected for a fully stochastic selection.

...
- Best daily n=10 MdAPE model: `daily_error_environment_support_n10` with cross-validated R² = 0.950, RMSE = 0.476 percentage points, MAE = 0.276.
- Best study-period MdAPE model: `period_error_n_city` with cross-validated R² = 0.890, RMSE = 0.749 percentage points, MAE = 0.531.
...
- Environment-only optimal k = 7; silhouette = 0.489; city-majority accuracy = 0.973.
- Environment + n=10 error optimal k = 7; silhouette = 0.467; city-majority accuracy = 0.964.
...
| Chicago | nearest_neighbor_km | period_mean_pm25_ugm3 | 277 | -0.107 | 0.076 |
...
- Chicago `highest_hourly`: median pairwise correlation 0.895; Spearman distance-correlation -0.563; median distance 13.95 km.
- Chicago `daily`: median pairwise correlation 0.970; Spearman distance-correlation -0.433; median distance 13.95 km.
- Chicago `monthly`: median pairwise correlation 0.912; Spearman distance-correlation -0.147; median distance 13.95 km.
...
- Chicago `highest_hourly`: median kNN5 Moran's I 0.156.
- Chicago `daily`: median kNN5 Moran's I 0.117.
- Chicago `monthly`: median kNN5 Moran's I 0.078.

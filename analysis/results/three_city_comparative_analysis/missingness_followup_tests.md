...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Chicago | temporal_structure | calendar_time | 0.126 | 0.038 | weak evidence | calendar_time | 1.345 | 3.791 | 2026-04 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Chicago | temporal_structure | calendar_time | 273 | 0.126 | 0.011 | 0.242 | 0.038 | weak evidence | 0.458 |
| Chicago | concentration | daily_median_pm25 | 272 | -0.069 | -0.186 | 0.052 | 0.252 | little evidence | -0.053 |
| Dhaka | spatial_variability | daily_spatial_sd | 365 | -0.133 | -0.225 | -0.038 | 0.010 | weak evidence | -2.213 |
| Dhaka | concentration | daily_mean_pm25 | 365 | -0.127 | -0.217 | -0.033 | 0.017 | weak evidence | -2.241 |
| Lucknow | temporal_structure | calendar_time | 365 | 0.423 | 0.325 | 0.515 | 0.000 | moderate evidence | 3.511 |
| Lucknow | spatial_variability | daily_spatial_cv | 365 | 0.298 | 0.205 | 0.386 | 0.000 | weak evidence | 1.351 |
...
| --- | --- | --- | --- | --- | --- | --- |
| Chicago | temporal_structure | calendar_time | 2.532 | 3.877 | 1.345 | 0.767 |
| Chicago | concentration | daily_median_pm25 | 2.447 | 2.373 | -0.074 | 0.454 |
| Dhaka | temporal_structure | calendar_time | 20.110 | 14.319 | -5.791 | 0.011 |
| Dhaka | spatial_variability | daily_spatial_sd | 15.089 | 9.838 | -5.251 | 0.001 |
...
| --- | --- | --- | --- | --- | --- | --- |
| Chicago | 9 | 2025-11 | 1.889 | 2026-04 | 5.680 | 3.791 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Chicago | sensor_level_variability | sensor_daily_pm25_sd | sensor_longest_missing_gap_days | 277 | -0.110 | 0.066 | weak evidence |
| Chicago | sensor_level_pm25 | sensor_period_mean_pm25 | sensor_record_missing_pct | 277 | 0.057 | 0.348 | little evidence |
| Dhaka | sensor_location | sensor_latitude | sensor_record_missing_pct | 35 | 0.491 | 0.002 | moderate evidence |
| Dhaka | sensor_location | sensor_latitude | sensor_daily_missing_pct | 35 | 0.364 | 0.033 | moderate evidence |
| Lucknow | sensor_location | sensor_latitude | sensor_record_missing_pct | 71 | -0.164 | 0.175 | weak evidence |
| Lucknow | sensor_location | sensor_latitude | sensor_daily_missing_pct | 71 | -0.120 | 0.305 | weak evidence |

# Spatial Manuscript Audit

## Scope And Guardrails

This audit checks spatial distance relations and spatial autocorrelation sensitivity for the three primary networks: Dhaka LCS, Lucknow LCS, and Chicago corrected LCS with collocation sensors excluded.
...
Permutation Moran's I uses 199 deterministic permutations per sampled time window with seed 20260525. Hourly and daily windows are deterministically thinned when needed to keep the audit reproducible and computationally bounded; weekly, monthly, and total-period windows are kept in full.
...
| --- | --- | --- | --- | --- | --- | --- |
| highest_resolution_individual_lcs_corrected_pm25 | 5442031 | 286 | 2025-08-31 19:00:05.181000 | 2026-04-30 18:59:56 | 2.938 | 20103.000 |
| highest_resolution_individual_lcs_raw_pm25 | 5442031 | 286 | 2025-08-31 19:00:05.181000 | 2026-04-30 18:59:56 | 2.938 | 20103.000 |
...
| Chicago | highest_hourly | 0.900 | 10-20 km | 14367.000 | 14.285 | 0.898 |
| Chicago | highest_hourly | 0.950 | 1-2 km | 705.000 | 1.485 | 0.950 |
| Chicago | daily | 0.900 |  |  |  |  |
| Chicago | daily | 0.950 |  |  |  |  |
| Chicago | weekly | 0.900 |  |  |  |  |
| Chicago | weekly | 0.950 |  |  |  |  |
| Chicago | monthly | 0.900 | 10-20 km | 14367.000 | 14.285 | 0.898 |
| Chicago | monthly | 0.950 | 5-10 km | 8670.000 | 7.547 | 0.923 |
...
| Chicago | highest_hourly | band_5km | 120 | 0.110 | 80.000 | 0.000 | 77.500 | 0.005 |
| Chicago | highest_hourly | knn_5 | 120 | 0.178 | 75.000 | 0.833 | 72.500 | 0.005 |
| Chicago | daily | band_5km | 240 | 0.080 | 80.000 | 0.000 | 77.500 | 0.005 |
| Chicago | daily | knn_5 | 240 | 0.116 | 74.583 | 0.000 | 68.333 | 0.005 |
| Chicago | monthly | band_5km | 9 | 0.050 | 88.889 | 0.000 | 55.556 | 0.010 |
| Chicago | monthly | knn_5 | 9 | 0.078 | 77.778 | 0.000 | 55.556 | 0.020 |
| Chicago | total_period | band_5km | 1 | 0.031 | 100.000 | 0.000 | 100.000 | 0.020 |
| Chicago | total_period | knn_5 | 1 | 0.063 | 100.000 | 0.000 | 100.000 | 0.020 |
...
| --- | --- | --- | --- |
| Chicago | 0.116 | 74.583 | 68.333 |
| Dhaka | -0.040 | 3.333 | 2.500 |
| Lucknow | -0.019 | 6.250 | 4.167 |

| city | median_observed_morans_i | positive_sig_pct | two_sided_sig_pct |
| --- | --- | --- | --- |
| Chicago | 0.078 | 77.778 | 55.556 |
...
- `spatial/results/distance_correlation/spatial_manuscript_audit_metadata.json`
